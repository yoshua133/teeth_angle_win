...
class ResNet4(nn.Module):
    ...
    def forward(self, x):
        ...
        x3 = self.fc3(x)
        x4 = self.fc4(x)
        out = torch.cat([x1,x2,x3,x4],axis=1)
...
def resnet50(pretrained=False,num_fc=1, **kwargs):
    ...
    #elif num_fc ==3:
    #    model = ResNet3(Bottleneck, [3, 4, 6, 3], **kwargs)
    #elif num_fc ==4:
    #    model = ResNet4(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
